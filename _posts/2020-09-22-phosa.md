---
title: Improving 3D Human-Object Spatial Arrangement Predictions using Affordance -- Project Ideas
...
Additionally, certain objects have multiple meshes to account for variations within the object class itself — for instance, there might be only one mesh for skateboards, but multiple 3D meshes for bikes, since the size and design can vary a lot. Here’s a really great illustration by PHOSA's authors describing the process:
